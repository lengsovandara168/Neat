  ...
  return (
    <div className="relative min-h-screen text-gray-800 dark:text-gray-100 overflow-hidden">
      ...
      <div className="fixed inset-0 -z-10">
        <div className="absolute inset-0 bg-linear-to-br from-pink-100 via-purple-50 to-blue-100 dark:from-gray-950 dark:via-purple-950/30 dark:to-gray-950" />

        {/* Animated gradient orbs */}
        <motion.div
          className="absolute top-0 -left-40 w-96 h-96 bg-linear-to-r from-pink-400 to-purple-400 rounded-full mix-blend-multiply dark:mix-blend-screen filter blur-3xl opacity-30 dark:opacity-20"
          animate={{
            x: [0, 100, 0],
            y: [0, 50, 0],
            scale: [1, 1.2, 1],
        ...
        />
        <motion.div
          className="absolute top-40 -right-40 w-96 h-96 bg-linear-to-r from-purple-400 to-pink-400 rounded-full mix-blend-multiply dark:mix-blend-screen filter blur-3xl opacity-30 dark:opacity-20"
          animate={{
            x: [0, -100, 0],
            y: [0, 100, 0],
            scale: [1, 1.3, 1],
        ...
        />
        <motion.div
          className="absolute -bottom-40 left-1/2 w-96 h-96 bg-linear-to-r from-blue-400 to-purple-400 rounded-full mix-blend-multiply dark:mix-blend-screen filter blur-3xl opacity-30 dark:opacity-20"
          animate={{
            x: [0, -50, 0],
            y: [0, -50, 0],
            scale: [1, 1.1, 1],
