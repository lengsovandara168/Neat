...
export function useConfetti() {
  useEffect(() => {
    ...
    const colors = ["#ff4e4e", "#4effa1", "#4ebfff", "#fffa4e", "#ff4efd", "#a14eff"];
    ...
    const confettiBurst = (count = 60, x = window.innerWidth / 2, spread = 160) => {
...
export function useScrollAnimations() {
  useEffect(() => {
    const storySections = document.querySelectorAll<HTMLElement>(".story-content");
